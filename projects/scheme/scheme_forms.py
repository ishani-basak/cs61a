...
def do_and_form(expressions, env):
    ...
    while expressions is not nil:
        ...
        if is_scheme_false(evaluated):
            return evaluated
        elif is_scheme_true(evaluated) and expressions.rest is nil:
            return evaluated
...
def do_or_form(expressions, env):
    ...
    while expressions is not nil:
        evaluated = scheme_eval(expressions.first, env)
        if is_scheme_true(evaluated):
            return evaluated
        elif is_scheme_false(evaluated) and expressions.rest is nil:
            return evaluated
        expressions = expressions.rest
    return False
    # END PROBLEM 12
