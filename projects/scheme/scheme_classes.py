...
class Frame:
    ...
    def __init__(self, parent):
        ...
        self.bindings = {} # dictionary representing the bindings in the frame, maps Scheme symbols 
        self.parent = parent # parent Frame instance, parent of Global Frame is None
...
class BuiltinProcedure(Procedure):
    ...
    def __init__(self, py_func, expect_env=False, name='builtin'):
        self.name = name
        self.py_func = py_func # implements scheme procedure
        self.expect_env = expect_env # indicates if py_func expects current env to be passed in
